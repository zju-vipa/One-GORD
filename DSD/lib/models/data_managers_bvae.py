...
class TeapotsDataManager(DataManager):
    def __init__(self, data_dir,data1Name, batch_size, image_shape, shuffle=True, 
                 gaps=True, file_ext='.npz', train_fract=0.8, 
                 dev_fract=None, inf=True, supervised=False):
        print('get data From data1 :'+data1Name)
        super(TeapotsDataManager, self).__init__(data_dir, data1Name, 
