...
Single_Num=320 # number of each digits
width=32
height=32
channel=3
classes=10
...
SVHN_LabelArray=np.zeros(shape=(Total_Num,classes))
# adding
...
save_dir='npz_datas/'
np.savez(save_dir+'SVHN10_img_N'+str(Total_Num)+'x'+str(width)+'x'+str(height)+'x'+str(channel)+'_testWithLabel_forMetrics.npz',images=SVHNArray0_1,masks=SVHN_maskArray0_1,labelsGT=SVHN_LabelArray)