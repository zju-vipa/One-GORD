...
class DIAE(object):
    ...
    def __build_graph(self):
        ...
        # Loss and optimizer
        self.__prep_loss_optimizer(norm_x1,norm_aux1,norm_aux2,norm_aux_GT1,norm_aux_GT2,x1_dual_out,aux1_c_p0,aux1_c_p1,aux2_c_p0,aux2_c_p1)
    ...
    def __prep_loss_optimizer(self,norm_x1,norm_aux1,norm_aux2,norm_aux_GT1,norm_aux_GT2,x1_dual_out,aux1_c_p0,aux1_c_p1,aux2_c_p0,aux2_c_p1):
        ...
        self.class_loss = self.aux1_class_loss+  self.aux1_bg_class_loss+self.aux2_class_loss+ self.aux2_bg_class_loss
    ...
    def train(self, n_iters, n_iters_per_epoch, stats_iters, ckpt_interval):
        ...
        for iteration in range(start_iter, n_iters):
            ...
            if (iteration < start_iter + 4) or iteration % stats_iters == 0:
                ...
                dev_loss,dev_rec_img_loss1,dev_rec_aux1_loss2,dev_rec_aux2_loss3,dev_rec_aux1_swap_loss4,dev_rec_aux2_swap_loss5,dev_rec_dual_loss6,head_loss,class_loss,aux1_class_loss,aux2_class_loss,aux1_bg_class_loss,aux2_bg_class_loss= \
                    self.session.run([self.loss,self.rec_img_loss1,self.rec_aux1_loss2,self.rec_aux2_loss3,self.rec_aux1_swap_loss4,self.rec_aux2_swap_loss5,self.rec_dual_loss6,self.head_loss,self.class_loss,self.aux1_class_loss,self.aux2_class_loss,self.aux1_bg_class_loss,self.aux2_bg_class_loss],
                ...
                running_cost = 0.
                print("Iteration:{0} \t| Train cost:{1:.1f} \t| Dev cost: {2:.1f}(img1_loss:{3:.1f},aux1_loss2:{4:.1f},aux2_loss3:{5:.1f},aux1_swap_loss:{6:.1f},aux2_swap_loss:{7:.1f},dual_swap_loss:{8:.1f},head loss:{9:.1f},class loss:{10:.1f}(aux1_class_loss:{11:.1f},aux2_class_loss:{12:.1f},aux1_bg_class_loss:{13:.1f},aux2_bg_class_loss:{14:.1f}))".
                      format(iteration, avg_cost, dev_loss,dev_rec_img_loss1,dev_rec_aux1_loss2,dev_rec_aux2_loss3,dev_rec_aux1_swap_loss4,dev_rec_aux2_swap_loss5,dev_rec_dual_loss6,head_loss,class_loss,aux1_class_loss,aux2_class_loss,aux1_bg_class_loss,aux2_bg_class_loss))
                logs.writelines("Iteration:{0} \t| Train cost:{1:.1f} \t| Dev cost: {2:.1f}(img1_loss:{3:.1f},aux1_loss2:{4:.1f},aux2_loss3:{5:.1f},aux1_swap_loss:{6:.1f},aux2_swap_loss:{7:.1f},dual_swap_loss:{8:.1f},head loss:{9:.1f},class loss:{10:.1f}(aux1_class_loss:{11:.1f},aux2_class_loss:{12:.1f},aux1_bg_class_loss:{13:.1f},aux2_bg_class_loss:{14:.1f}))\n".
                      format(iteration, avg_cost, dev_loss,dev_rec_img_loss1,dev_rec_aux1_loss2,dev_rec_aux2_loss3,dev_rec_aux1_swap_loss4,dev_rec_aux2_swap_loss5,dev_rec_dual_loss6,head_loss,class_loss,aux1_class_loss,aux2_class_loss,aux1_bg_class_loss,aux2_bg_class_loss))
