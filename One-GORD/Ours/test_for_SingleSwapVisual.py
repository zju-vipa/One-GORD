...
def main(_):
    ...
    if FLAGS.visualize_reconstruct:
        sampleNum =2880 
        dataVisualName1='SVHN10_img_N2880x32x32x3_testWithLabel_forSingleVisual1_0'
        dataVisualName2='SVHN10_img_N2880x32x32x3_testWithLabel_forSingleVisual2_0'
        ...
        #saved_step = ae.load()
        saved_step = ae2input.load_fixedNum(6500)
        assert saved_step > 1, "A trained model is needed to encode the data!"
        
        pathForSave='SingleVisualImgsResults_{}'.format(0)
        try:
