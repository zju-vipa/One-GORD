...
class DataManager(object):
    def __init__(self, data_dir, dataset_name1,dataset_name2,batch_size, image_shape, 
        ...
        imgs, masks, gts = self.__get_datasets(imgs1,masks1,imgs2,masks2)
    ...
    def __get_datasets(self, imgs1,masks1):
        ...
        if self.supervised:
            ...
            train_gts1, dev_gts1, test_gts1,train_gts2, dev_gts2, test_gts2= None, None, None
...
class ShapesDataManager(DataManager):
    def __init__(self, data_dir,data1Name,data2Name, batch_size, image_shape, shuffle=False, 
        ...
        super(ShapesDataManager, self).__init__(data_dir,
              data1Name,data2Name, batch_size, image_shape, shuffle, file_ext,
